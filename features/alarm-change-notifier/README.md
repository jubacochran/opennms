...
~~~~
karaf@root> feature:addurl mvn:org.opennms.plugins/alarm-change-notifier/19.0.0-SNAPSHOT/xml/features
karaf@root> feature:install alarm-change-notifier

(or feature:install alarm-change-notifier/19.0.0-SNAPSHOT for a specific version of the feature)
~~~~
