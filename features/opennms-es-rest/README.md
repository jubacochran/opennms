...
karaf@root> feature:addurl mvn:org.opennms.plugins/opennms-es-rest/19.0.0-SNAPSHOT/xml/features
karaf@root> feature:install opennms-es-rest

(or feature:install opennms-es-rest/19.0.0-SNAPSHOT for a specific version of the feature)
~~~~
